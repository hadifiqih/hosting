...
function doRequest(_ref) {
  var method = _ref.method, path = _ref.path, _ref$body = _ref.body, body = _ref$body === void 0 ? null : _ref$body, _ref$headers = _ref.headers, headers = _ref$headers === void 0 ? {} : _ref$headers, _ref$credentials = _ref.credentials, credentials = _ref$credentials === void 0 ? "same-origin" : _ref$credentials;
  var options = {
    method,
    headers,
    credentials
...
var TokenProvider = function() {
  function TokenProvider2() {
    var _ref = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, url = _ref.url, queryParams = _ref.queryParams, headers = _ref.headers, credentials = _ref.credentials;
    classCallCheck(this, TokenProvider2);
    this.url = url;
    this.queryParams = queryParams;
    this.headers = headers;
    this.credentials = credentials;
  }
  createClass(TokenProvider2, [{
    key: "fetchToken",
    value: function() {
...
var DeviceStateStore = function() {
  function DeviceStateStore2(instanceId) {
    classCallCheck(this, DeviceStateStore2);
    this._instanceId = instanceId;
    this._dbConn = null;
  }
  createClass(DeviceStateStore2, [{
    key: "connect",
...
var Client = function() {
  function Client2(config) {
    ...
    var instanceId = config.instanceId, _config$endpointOverr = config.endpointOverride, endpointOverride = _config$endpointOverr === void 0 ? null : _config$endpointOverr, _config$serviceWorker = config.serviceWorkerRegistration, serviceWorkerRegistration = _config$serviceWorker === void 0 ? null : _config$serviceWorker;
    ...
    this._endpoint = endpointOverride;
            ...
            while (1) {
              switch (_context12.prev = _context12.next) {
                ...
                case 2:
                  ...
                  if (!(interests === void 0 || interests === null)) {
                    _context12.next = 5;
                    break;
                  }
            ...
            while (1) {
              switch (_context15.prev = _context15.next) {
                ...
                case 8:
                  ...
                  return this._deviceStateStore.clear();
                case 10:
                  this._clearPushToken()["catch"](function() {
                  });
                  this._deviceId = null;
                  this._token = null;
                  this._userId = null;
...
var validateInterestName = function validateInterestName2(interest) {
  if (interest === void 0 || interest === null) {
...
//# sourceMappingURL=@pusher_push-notifications-web.js.map
